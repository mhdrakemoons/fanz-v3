...
export const metadata = {
  title: "Top 10 Platforms for Twitter/X | Fanzsocial",
  description: "Compare the best platforms for Twitter/X marketing, growth, and engagement. Find the right tools for your needs.",
};

export default function TwitterXPage() {
  const category = "Twitter/X";
    ...
    <div className="min-h-screen">
      <div className="w-full max-w-[87.5rem] mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-5">
        <main className="flex flex-col gap-12 md:gap-16">
          {/* Custom Hero Section for Twitter/X */}
          <section id="twitter-x-hero" className="relative bg-white pb-6 md:pb-10">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center text-center py-6 md:py-10">
              <div className="z-10 flex flex-col items-center gap-3">
                ...
                <h1 className="text-[#111827] text-5xl sm:text-6xl md:text-7xl font-black leading-tight tracking-tighter max-w-4xl text-balance">
                  Top 10 Platforms
                  <span className="block">for Twitter/X</span>
                </h1>
                <h2 className="text-gray-600 text-lg font-normal leading-normal max-w-2xl text-balance">
                  Compare the best platforms for Twitter/X marketing, growth, and engagement. Find the right tools for your needs.
                </h2>
          ...
          {metas.length > 0 ? (
            ...
            <div className="text-center py-16">
              <p className="text-gray-600 text-lg">No comparisons found for Twitter/X yet. Check back soon!</p>
            </div>
          )}
        </main>
      </div>
